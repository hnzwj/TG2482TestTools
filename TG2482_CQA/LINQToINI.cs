...
namespace TestTools
{
    ...
    public class LINQToINI
    {
        ...
        public string GetProfileAsString(String section, String keyName, String defaultValue)
        {
            if (INIElement == null)
            {   // 抛出异常：无效的数据源
                throw new ApplicationException("Invalid Data Source!");
        ...
        /// <param name="defaultValue">缺省键值</param>
        /// <returns>键值（整数值）</returns>
        public Int32 GetProfileAsInt(String section, String keyName, Int32 defaultValue)
        {
            if (INIElement == null)
            {   // 抛出异常：无效的数据源
                throw new ApplicationException("Invalid Data Source!");
        ...
        /// <param name="keyName">键名</param>
        /// <param name="defaultValue">缺省键值</param>
        /// <returns>键值（bool）</returns>
        public bool GetProfileAsBool(String section, String keyName, bool defaultValue)
        {
            if (INIElement == null)
            {   // 抛出异常：无效的数据源
                throw new ApplicationException("Invalid Data Source!");
            ...
            else
            {
                ...
                {   // 将字符串转换为整数值（注意：可能会抛出异常）
                    return Convert.ToBoolean(ValueQuery[0]);
                }
            }
        }
        /// <summary>
